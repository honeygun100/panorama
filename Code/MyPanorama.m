...
for i = 1:length(Custom1_file_numbers)
  jpgFilename = sprintf('%d.jpg', Custom1_file_numbers(i));
  fullFileName = fullfile("..\Images\input\Custom1\", jpgFilename);                                                                                                 
  Custom1_photos{i} = imrotate(cast(imread(fullFileName), "double"),-90);
  %imshow(cast(Custom1_photos{i},"uint8"));
end
...
panorama_set3_pt4 = load("..\Images\input\panos\pano_Set3_pt4.mat"); % 6 and 5
panorama_set3_pt4 = panorama_set3_pt4.panorama;
panorama_set3_pt5 = load("..\Images\input\panos\pano_Set3_pt5.mat"); % panorama_set3_pt4 and 7
panorama_set3_pt5 = panorama_set3_pt5.panorama;
panorama_set3_pt6 = load("..\Images\input\panos\pano_Set3_pt6.mat"); % panorama_set3_pt4 and 7
panorama_set3_pt6 = panorama_set3_pt6.panorama;
panorama_set3_pt6 = imresize(panorama_set3_pt6, [1035/5 1270/5]);

%imshow(cast(panorama_set3_pt3,'uint8'));


%TestSet1
panorama_TestSet1_pt1 = load("..\Images\input\panos\pano_TestSet1_pt1.mat");%1 and 2
panorama_TestSet1_pt1 = panorama_TestSet1_pt1.panorama;
panorama_TestSet1_pt2 = load("..\Images\input\panos\pano_TestSet1_pt2.mat");%4 and 3
panorama_TestSet1_pt2 = panorama_TestSet1_pt2.panorama;
panorama_TestSet1_final = load("..\Images\input\panos\pano_TestSet1_final.mat");%4 and 3
panorama_TestSet1_final = panorama_TestSet1_final.panorama;
imshow(cast(panorama_TestSet1_final, "uint8"));


%TestSet2
panorama_TestSet2_pt1 = load("..\Images\input\panos\pano_TestSet2_pt1.mat");%1 and 2
panorama_TestSet2_pt1 = panorama_TestSet2_pt1.panorama;
panorama_TestSet2_pt2 = load("..\Images\input\panos\pano_TestSet2_pt2.mat");%3
panorama_TestSet2_pt2 = panorama_TestSet2_pt2.panorama;
panorama_TestSet2_pt3 = load("..\Images\input\panos\pano_TestSet2_pt3.mat");%7
panorama_TestSet2_pt3 = panorama_TestSet2_pt3.panorama;
panorama_TestSet2_pt3 = imresize(panorama_TestSet2_pt3, [4252/4 3427/4]);% make resolution lower to fix time complexity

panorama_TestSet2_pt4 = load("..\Images\input\panos\pano_TestSet2_pt4.mat");%8 and 4
panorama_TestSet2_pt4 = panorama_TestSet2_pt4.panorama;
panorama_TestSet2_pt5 = load("..\Images\input\panos\pano_TestSet2_pt5.mat");%9
panorama_TestSet2_pt5 = panorama_TestSet2_pt5.panorama;
panorama_TestSet2_pt6 = load("..\Images\input\panos\pano_TestSet2_pt6.mat");%5
panorama_TestSet2_pt6 = panorama_TestSet2_pt6.panorama;
panorama_TestSet2_pt6 = imresize(panorama_TestSet2_pt6, [2182/4 2159/4]);% make resolution lower to fix time complexity


%imshow(cast(panorama_TestSet2_pt3, "uint8"));

%TestSet3
panorama_TestSet3_pt1 = load("..\Images\input\panos\pano_TestSet3_pt1.mat"); %2 and 3
panorama_TestSet3_pt1 = panorama_TestSet3_pt1.panorama;
panorama_TestSet3_final = load("..\Images\input\panos\pano_TestSet3_final.mat");%1
panorama_TestSet3_final = panorama_TestSet3_final.panorama;
%imshow(cast(panorama_TestSet3_final, "uint8"));
...
%Custom 1
panorama_Custom1_pt1 = load("..\Images\input\panos\pano_Custom1_pt1.mat");
panorama_Custom1_pt1 = panorama_Custom1_pt1.panorama;
panorama_Custom1_final = load("..\Images\input\panos\pano_Custom1_final.mat");
panorama_Custom1_final = panorama_Custom1_final.panorama;
%imshow(cast(panorama_Custom1_final, "uint8"));
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    image_1_rgb = cast(panorama_set3_pt3, "uint8");
    image_1 = rgb2gray(image_1_rgb);
    image_1_cornerscore = cornermetric(image_1);

    image_2_rgb = cast(panorama_set3_pt6, "uint8");    
    ...
    figure;
    imagesc(cast(panorama_set3_pt3,"uint8"));
...
figure;
imagesc(cast(panorama_set3_pt3, "uint8"));    %imagesc instead of imshow?
